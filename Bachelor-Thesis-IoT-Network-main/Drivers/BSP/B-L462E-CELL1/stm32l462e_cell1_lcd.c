...
/** @defgroup STM32L462E_CELL1_LCD_Private_Variables STM32L462E_CELL1 LCD Private Variables
  * @{
  */
...
int32_t LCD_IO_Init(void)
{
  ...
  /* GPIO_InitStruct.Pull = GPIO_NOPULL not needed, already done in previous lines */
  /* GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW not needed, already done in previous lines */
  ...
  /* GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD not needed, already done in previous lines */
  /* GPIO_InitStruct.Pull = GPIO_NOPULL not needed, already done in previous lines */
  /* GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW not needed, already done in previous lines */
